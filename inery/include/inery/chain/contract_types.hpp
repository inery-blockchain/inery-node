...
using action_name    = inery::chain::action_name;
...
FC_REFLECT( inery::chain::newaccount                       , (creator)(name)(owner)(active) )
FC_REFLECT( inery::chain::setcode                          , (account)(vmtype)(vmversion)(code) )
FC_REFLECT( inery::chain::setabi                           , (account)(abi) )
FC_REFLECT( inery::chain::updateauth                       , (account)(permission)(parent)(auth) )
FC_REFLECT( inery::chain::deleteauth                       , (account)(permission) )
FC_REFLECT( inery::chain::linkauth                         , (account)(code)(type)(requirement) )
FC_REFLECT( inery::chain::unlinkauth                       , (account)(code)(type) )
FC_REFLECT( inery::chain::canceldelay                      , (canceling_auth)(trx_id) )
FC_REFLECT( inery::chain::onerror                          , (sender_id)(sent_trx) )
