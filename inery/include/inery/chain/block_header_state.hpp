...
FC_REFLECT( inery::chain::detail::block_header_state_common,
            (block_num)
...
FC_REFLECT( inery::chain::detail::schedule_info,
            (schedule_lib_num)
            (schedule_hash)
            (schedule)
)

FC_REFLECT_DERIVED(  inery::chain::block_header_state, (inery::chain::detail::block_header_state_common),
                     (id)
                     (header)
                     (pending_schedule)
...
FC_REFLECT( inery::chain::legacy::snapshot_block_header_state_v2::schedule_info,
          ( schedule_lib_num )
          ( schedule_hash )
          ( schedule )
)
...
FC_REFLECT( inery::chain::legacy::snapshot_block_header_state_v2,
          ( block_num )
          ( dpos_proposed_irreversible_blocknum )
          ( dpos_irreversible_blocknum )
          ( active_schedule )
