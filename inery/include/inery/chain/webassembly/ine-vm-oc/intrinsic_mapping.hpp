...
constexpr auto intrinsic_table = boost::hana::make_tuple(
   "inevmoc_internal.unreachable"_s,
   "inevmoc_internal.grow_memory"_s,
   "inevmoc_internal.div0_or_overflow"_s,
   "inevmoc_internal.indirect_call_mismatch"_s,
   "inevmoc_internal.indirect_call_oob"_s,
   "inevmoc_internal.depth_assert"_s,
   "inery_injection.call_depth_assert"_s,  //these two are never used by INE VM OC but all intrinsics
   "inery_injection.checktime"_s,          //must be mapped
   "env.__ashlti3"_s,
   "env.__ashrti3"_s,
   "env.__lshlti3"_s,
   "env.__lshrti3"_s,
   ...
   "env.set_proposed_masters"_s,
   "env.set_proposed_masters_ex"_s,
   ...
   "env.abort"_s,
   "env.inery_assert"_s,
   "env.inery_assert_message"_s,
   "env.inery_assert_code"_s,
   "env.inery_exit"_s,
   ...
   "env.memcmp"_s,
   "env.memset"_s,
   "inery_injection._inery_f32_add"_s,
   "inery_injection._inery_f32_sub"_s,
   "inery_injection._inery_f32_mul"_s,
   "inery_injection._inery_f32_div"_s,
   "inery_injection._inery_f32_min"_s,
   "inery_injection._inery_f32_max"_s,
   "inery_injection._inery_f32_copysign"_s,
   "inery_injection._inery_f32_abs"_s,
   "inery_injection._inery_f32_neg"_s,
   "inery_injection._inery_f32_sqrt"_s,
   "inery_injection._inery_f32_ceil"_s,
   "inery_injection._inery_f32_floor"_s,
   "inery_injection._inery_f32_trunc"_s,
   "inery_injection._inery_f32_nearest"_s,
   "inery_injection._inery_f32_eq"_s,
   "inery_injection._inery_f32_ne"_s,
   "inery_injection._inery_f32_lt"_s,
   "inery_injection._inery_f32_le"_s,
   "inery_injection._inery_f32_gt"_s,
   "inery_injection._inery_f32_ge"_s,
   "inery_injection._inery_f64_add"_s,
   "inery_injection._inery_f64_sub"_s,
   "inery_injection._inery_f64_mul"_s,
   "inery_injection._inery_f64_div"_s,
   "inery_injection._inery_f64_min"_s,
   "inery_injection._inery_f64_max"_s,
   "inery_injection._inery_f64_copysign"_s,
   "inery_injection._inery_f64_abs"_s,
   "inery_injection._inery_f64_neg"_s,
   "inery_injection._inery_f64_sqrt"_s,
   "inery_injection._inery_f64_ceil"_s,
   "inery_injection._inery_f64_floor"_s,
   "inery_injection._inery_f64_trunc"_s,
   "inery_injection._inery_f64_nearest"_s,
   "inery_injection._inery_f64_eq"_s,
   "inery_injection._inery_f64_ne"_s,
   "inery_injection._inery_f64_lt"_s,
   "inery_injection._inery_f64_le"_s,
   "inery_injection._inery_f64_gt"_s,
   "inery_injection._inery_f64_ge"_s,
   "inery_injection._inery_f32_promote"_s,
   "inery_injection._inery_f64_demote"_s,
   "inery_injection._inery_f32_trunc_i32s"_s,
   "inery_injection._inery_f64_trunc_i32s"_s,
   "inery_injection._inery_f32_trunc_i32u"_s,
   "inery_injection._inery_f64_trunc_i32u"_s,
   "inery_injection._inery_f32_trunc_i64s"_s,
   "inery_injection._inery_f64_trunc_i64s"_s,
   "inery_injection._inery_f32_trunc_i64u"_s,
   "inery_injection._inery_f64_trunc_i64u"_s,
   "inery_injection._inery_i32_to_f32"_s,
   "inery_injection._inery_i64_to_f32"_s,
   "inery_injection._inery_ui32_to_f32"_s,
   "inery_injection._inery_ui64_to_f32"_s,
   "inery_injection._inery_i32_to_f64"_s,
   "inery_injection._inery_i64_to_f64"_s,
   "inery_injection._inery_ui32_to_f64"_s,
   "inery_injection._inery_ui64_to_f64"_s
);
