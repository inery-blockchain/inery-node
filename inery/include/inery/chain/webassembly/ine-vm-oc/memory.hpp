...
class memory {
      static constexpr uint64_t wasm_memory_size                  = inery::chain::wasm_constraints::maximum_linear_memory;
      ...
      static constexpr uint64_t mutable_global_size               = 8u  * inery::chain::wasm_constraints::maximum_mutable_globals/4u;
      static constexpr uint64_t table_size                        = 16u * inery::chain::wasm_constraints::maximum_table_elements;
      static constexpr size_t   wcb_allowance                     = 512u;
      static_assert(sizeof(control_block) <= wcb_allowance, "INE VM OC memory doesn't set aside enough memory for control block");
   ...
   public:
      ...
      static_assert(-cb_offset == INE_VM_OC_CONTROL_BLOCK_OFFSET, "INE VM OC control block offset has slid out of place somehow");
      static_assert(stride == INE_VM_OC_MEMORY_STRIDE, "INE VM OC memory stride has slid out of place somehow");
...
#define OFFSET_OF_CONTROL_BLOCK_MEMBER(M) (-(int)inery::chain::inevmoc::memory::cb_offset + (int)offsetof(inery::chain::inevmoc::control_block, M))
#define OFFSET_OF_FIRST_INTRINSIC ((int)-inery::chain::inevmoc::memory::first_intrinsic_offset)