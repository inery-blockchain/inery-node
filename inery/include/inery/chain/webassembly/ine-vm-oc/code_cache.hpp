...
namespace std {
    template<> struct hash<inery::chain::inevmoc::code_tuple> {
        size_t operator()(const inery::chain::inevmoc::code_tuple& ct) const noexcept {
...
class code_cache_base {
   public:
      code_cache_base(const bfs::path data_dir, const inevmoc::config& inevmoc_config, const chainbase::database& db);
      ~code_cache_base();
...
class code_cache_async : public code_cache_base {
   public:
      code_cache_async(const bfs::path data_dir, const inevmoc::config& inevmoc_config, const chainbase::database& db);
      ~code_cache_async();
