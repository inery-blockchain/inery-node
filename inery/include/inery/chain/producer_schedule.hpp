...
namespace inery { namespace chain {
   ...
   namespace legacy {
      /**
       *  Used as part of the producer_schedule_type, maps the master name to their key.
       */
      struct producer_key {
...
FC_REFLECT( inery::chain::legacy::producer_key, (producer_name)(block_signing_key) )
FC_REFLECT( inery::chain::legacy::producer_schedule_type, (version)(producers) )
FC_REFLECT( inery::chain::block_signing_authority_v0, (threshold)(keys))
FC_REFLECT( inery::chain::producer_authority, (producer_name)(authority) )
FC_REFLECT( inery::chain::producer_authority_schedule, (version)(producers) )
FC_REFLECT_DERIVED( inery::chain::producer_schedule_change_extension, (inery::chain::producer_authority_schedule), )

FC_REFLECT( inery::chain::shared_block_signing_authority_v0, (threshold)(keys))
FC_REFLECT( inery::chain::shared_producer_authority, (producer_name)(authority) )
FC_REFLECT( inery::chain::shared_producer_authority_schedule, (version)(producers) )
