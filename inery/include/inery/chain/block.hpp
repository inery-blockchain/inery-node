...
FC_REFLECT_ENUM( inery::chain::transaction_receipt::status_enum,
                 (executed)(soft_fail)(hard_fail)(delayed)(expired) )

FC_REFLECT(inery::chain::transaction_receipt_header, (status)(cpu_usage_us)(net_usage_words) )
FC_REFLECT_DERIVED(inery::chain::transaction_receipt, (inery::chain::transaction_receipt_header), (trx) )
FC_REFLECT(inery::chain::additional_block_signatures_extension, (signatures));
FC_REFLECT_DERIVED(inery::chain::signed_block, (inery::chain::signed_block_header), (transactions)(block_extensions) )
