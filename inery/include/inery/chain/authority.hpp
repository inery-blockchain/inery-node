...
namespace config {
   ...
   struct billable_size<shared_authority> {
      static const uint64_t value = (3 * config::fixed_overhead_shared_vector_mem_bytes) + 4;
   };
}
...
FC_REFLECT(inery::chain::permission_level_weight, (permission)(weight) )
FC_REFLECT(inery::chain::key_weight, (key)(weight) )
FC_REFLECT(inery::chain::wait_weight, (wait_sec)(weight) )
FC_REFLECT(inery::chain::authority, (threshold)(keys)(accounts)(waits) )
FC_REFLECT(inery::chain::shared_key_weight, (key)(weight) )
FC_REFLECT(inery::chain::shared_authority, (threshold)(keys)(accounts)(waits) )
FC_REFLECT(inery::chain::shared_public_key, (pubkey))