...
CHAINBASE_SET_INDEX_TYPE(inery::chain::transaction_object, inery::chain::transaction_multi_index)

FC_REFLECT(inery::chain::transaction_object, (expiration)(trx_id))
