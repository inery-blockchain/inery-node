...
CHAINBASE_SET_INDEX_TYPE(inery::chain::code_object, inery::chain::code_index)

FC_REFLECT(inery::chain::code_object, (code_hash)(code)(code_ref_count)(first_block_used)(vm_type)(vm_version))
