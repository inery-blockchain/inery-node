...
namespace inery { namespace chain {
   ...
   enum object_type
   {
      ...
      account_mem_correction_object_type,
      code_object_type,
   ...
   /**
    *  Important notes on using chainbase objects in INERY code:
    *
    ...
    *  others are due to requirements to ensure determinism in the INERY chain library.
    *
...
FC_REFLECT_EMPTY( inery::chain::void_t )
