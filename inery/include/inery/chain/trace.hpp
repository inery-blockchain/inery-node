...
#include <inery/chain/action_receipt.hpp>
...
namespace inery { namespace chain {
   ...
   struct action_trace {
      ...
      flat_set<account_delta>         account_mem_deltas;
   ...
   struct transaction_trace {
      ...
      fc::optional<account_delta>                account_mem_delta;
...
FC_REFLECT( inery::chain::account_delta,
            (account)(delta) )

FC_REFLECT( inery::chain::action_trace,
               ...
               (producer_block_id)(account_mem_deltas)(except)(error_code) )

FC_REFLECT( inery::chain::transaction_trace, (id)(block_num)(block_time)(producer_block_id)
                                             (receipt)(elapsed)(net_usage)(scheduled)
                                             (action_traces)(account_mem_delta)(failed_dtrx_trace)(except)(error_code) )
