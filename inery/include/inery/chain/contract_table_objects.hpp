...
#include <inery/chain/multi_index_includes.hpp>
...
namespace config {
   ...
   struct billable_size<table_id_object> {
      static const uint64_t overhead = overhead_per_row_per_index_mem_bytes * 2;  ///< overhead for 2x indices internal-key and code,scope,table
      static const uint64_t value = 44 + overhead; ///< 44 bytes for constant size fields + overhead
   };

   template<>
   struct billable_size<key_value_object> {
      static const uint64_t overhead = overhead_per_row_per_index_mem_bytes * 2;  ///< overhead for potentially single-row table, 2x indices internal-key and primary key
   ...
   struct billable_size<index64_object> {
      static const uint64_t overhead = overhead_per_row_per_index_mem_bytes * 3;  ///< overhead for potentially single-row table, 3x indices internal-key, primary key and primary+secondary key
...
CHAINBASE_SET_INDEX_TYPE(inery::chain::table_id_object, inery::chain::table_id_multi_index)
CHAINBASE_SET_INDEX_TYPE(inery::chain::key_value_object, inery::chain::key_value_index)

CHAINBASE_SET_INDEX_TYPE(inery::chain::index64_object, inery::chain::index64_index)
CHAINBASE_SET_INDEX_TYPE(inery::chain::index128_object, inery::chain::index128_index)
CHAINBASE_SET_INDEX_TYPE(inery::chain::index256_object, inery::chain::index256_index)
CHAINBASE_SET_INDEX_TYPE(inery::chain::index_double_object, inery::chain::index_double_index)
CHAINBASE_SET_INDEX_TYPE(inery::chain::index_long_double_object, inery::chain::index_long_double_index)

FC_REFLECT(inery::chain::table_id_object, (code)(scope)(table)(payer)(count) )
FC_REFLECT(inery::chain::key_value_object, (primary_key)(payer)(value) )

#define REFLECT_SECONDARY(type)\
  FC_REFLECT(type, (primary_key)(payer)(secondary_key) )

REFLECT_SECONDARY(inery::chain::index64_object)
REFLECT_SECONDARY(inery::chain::index128_object)
REFLECT_SECONDARY(inery::chain::index256_object)
REFLECT_SECONDARY(inery::chain::index_double_object)
REFLECT_SECONDARY(inery::chain::index_long_double_object)
