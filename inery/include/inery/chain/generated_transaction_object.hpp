...
namespace inery { namespace chain {
   ...
   namespace config {
      ...
      struct billable_size<generated_transaction_object> {
         static const uint64_t overhead = overhead_per_row_per_index_mem_bytes * 5;  ///< overhead for 5x indices internal-key, txid, expiration, delay, sender_id
...
CHAINBASE_SET_INDEX_TYPE(inery::chain::generated_transaction_object, inery::chain::generated_transaction_multi_index)

FC_REFLECT(inery::chain::generated_transaction_object, (trx_id)(sender)(sender_id)(payer)(delay_until)(expiration)(published)(packed_trx))
