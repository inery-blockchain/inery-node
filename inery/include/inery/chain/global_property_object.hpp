...
CHAINBASE_SET_INDEX_TYPE(inery::chain::global_property_object, inery::chain::global_property_multi_index)
CHAINBASE_SET_INDEX_TYPE(inery::chain::dynamic_global_property_object,
                         inery::chain::dynamic_global_property_multi_index)

FC_REFLECT(inery::chain::global_property_object,
            (proposed_schedule_block_num)(proposed_schedule)(configuration)(chain_id)
          )

FC_REFLECT(inery::chain::legacy::snapshot_global_property_object_v2,
            (proposed_schedule_block_num)(proposed_schedule)(configuration)
          )

FC_REFLECT(inery::chain::snapshot_global_property_object,
            (proposed_schedule_block_num)(proposed_schedule)(configuration)(chain_id)
          )

FC_REFLECT(inery::chain::dynamic_global_property_object,
