...
namespace inery { namespace vm {
   ...
   #define CHOOSE_FN(name) nullptr
      ...
      void emit_f32_eq() {
         ...
         emit_f32_relop(0x00, CHOOSE_FN(_inery_f32_eq), false, false);
      }

      void emit_f32_ne() {
         auto icount = softfloat_instr(24,47);
         emit_f32_relop(0x00, CHOOSE_FN(_inery_f32_eq), false, true);
      }

      void emit_f32_lt() {
         auto icount = softfloat_instr(25,45);
         emit_f32_relop(0x01, CHOOSE_FN(_inery_f32_lt), false, false);
      }

      void emit_f32_gt() {
         auto icount = softfloat_instr(25,45);
         emit_f32_relop(0x01, CHOOSE_FN(_inery_f32_lt), true, false);
      }

      void emit_f32_le() {
         auto icount = softfloat_instr(25,45);
         emit_f32_relop(0x02, CHOOSE_FN(_inery_f32_le), false, false);
      }

      void emit_f32_ge() {
         auto icount = softfloat_instr(25,45);
         emit_f32_relop(0x02, CHOOSE_FN(_inery_f32_le), true, false);
      }

      // --------------- f64 relops ----------------------
      void emit_f64_eq() {
         auto icount = softfloat_instr(25,47);
         emit_f64_relop(0x00, CHOOSE_FN(_inery_f64_eq), false, false);
      }

      void emit_f64_ne() {
         auto icount = softfloat_instr(24,49);
         emit_f64_relop(0x00, CHOOSE_FN(_inery_f64_eq), false, true);
      }

      void emit_f64_lt() {
         auto icount = softfloat_instr(25,47);
         emit_f64_relop(0x01, CHOOSE_FN(_inery_f64_lt), false, false);
      }

      void emit_f64_gt() {
         auto icount = softfloat_instr(25,47);
         emit_f64_relop(0x01, CHOOSE_FN(_inery_f64_lt), true, false);
      }

      void emit_f64_le() {
         auto icount = softfloat_instr(25,47);
         emit_f64_relop(0x02, CHOOSE_FN(_inery_f64_le), false, false);
      }

      void emit_f64_ge() {
         auto icount = softfloat_instr(25,47);
         emit_f64_relop(0x02, CHOOSE_FN(_inery_f64_le), true, false);
      }
      ...
      void emit_f32_ceil() {
         ...
         if constexpr (use_softfloat) {
            return emit_softfloat_unop(CHOOSE_FN(_inery_f32_ceil));
         }
      ...
      void emit_f32_floor() {
         auto icount = softfloat_instr(12, 36);
         if constexpr (use_softfloat) {
            return emit_softfloat_unop(CHOOSE_FN(_inery_f32_floor));
         }
      ...
      void emit_f32_trunc() {
         auto icount = softfloat_instr(12, 36);
         if constexpr (use_softfloat) {
            return emit_softfloat_unop(CHOOSE_FN(_inery_f32_trunc));
         }
      ...
      void emit_f32_nearest() {
         auto icount = softfloat_instr(12, 36);
         if constexpr (use_softfloat) {
            return emit_softfloat_unop(CHOOSE_FN(_inery_f32_nearest));
         }
      ...
      void emit_f32_sqrt() {
         ...
         if constexpr (use_softfloat) {
            return emit_softfloat_unop(CHOOSE_FN(_inery_f32_sqrt));
         }
         // sqrtss (%rsp), %xmm0
      ...
      void emit_f32_add() {
         ...
         emit_f32_binop(0x58, CHOOSE_FN(_inery_f32_add));
      }
      void emit_f32_sub() {
         auto icount = softfloat_instr(21, 44);
         emit_f32_binop(0x5c, CHOOSE_FN(_inery_f32_sub));
      }
      void emit_f32_mul() {
         auto icount = softfloat_instr(21, 44);
         emit_f32_binop(0x59, CHOOSE_FN(_inery_f32_mul));
      }
      void emit_f32_div() {
         auto icount = softfloat_instr(21, 44);
         emit_f32_binop(0x5e, CHOOSE_FN(_inery_f32_div));
      }
      void emit_f32_min() {
         auto icount = softfloat_instr(47, 44);
        if constexpr(use_softfloat) {
           emit_f32_binop_softfloat(CHOOSE_FN(_inery_f32_min));
           return;
        }
        // mov (%rsp), %eax
      ...
      void emit_f32_max() {
         auto icount = softfloat_instr(47, 44);
        if(use_softfloat) {
           emit_f32_binop_softfloat(CHOOSE_FN(_inery_f32_max));
           return;
        }
        // mov (%rsp), %eax
        emit_bytes(0x8b, 0x04, 0x24);
      ...
      void emit_f64_ceil() {
         ...
         if constexpr (use_softfloat) {
            return emit_softfloat_unop(CHOOSE_FN(_inery_f64_ceil));
         }
      ...
      void emit_f64_floor() {
         auto icount = softfloat_instr(12, 38);
         if constexpr (use_softfloat) {
            return emit_softfloat_unop(CHOOSE_FN(_inery_f64_floor));
         }
      ...
      void emit_f64_trunc() {
         auto icount = softfloat_instr(12, 38);
         if constexpr (use_softfloat) {
            return emit_softfloat_unop(CHOOSE_FN(_inery_f64_trunc));
         }
      ...
      void emit_f64_nearest() {
         auto icount = softfloat_instr(12, 38);
         if constexpr (use_softfloat) {
            return emit_softfloat_unop(CHOOSE_FN(_inery_f64_nearest));
         }
      ...
      void emit_f64_sqrt() {
         ...
         if constexpr (use_softfloat) {
            return emit_softfloat_unop(CHOOSE_FN(_inery_f64_sqrt));
         }
         // sqrtss (%rsp), %xmm0
      ...
      void emit_f64_add() {
         ...
         emit_f64_binop(0x58, CHOOSE_FN(_inery_f64_add));
      }
      void emit_f64_sub() {
         auto icount = softfloat_instr(21, 47);
         emit_f64_binop(0x5c, CHOOSE_FN(_inery_f64_sub));
      }
      void emit_f64_mul() {
         auto icount = softfloat_instr(21, 47);
         emit_f64_binop(0x59, CHOOSE_FN(_inery_f64_mul));
      }
      void emit_f64_div() {
         auto icount = softfloat_instr(21, 47);
         emit_f64_binop(0x5e, CHOOSE_FN(_inery_f64_div));
      }
      void emit_f64_min() {
         auto icount = softfloat_instr(49, 47);
         if(use_softfloat) {
            emit_f64_binop_softfloat(CHOOSE_FN(_inery_f64_min));
            return;
         }
         // mov (%rsp), %rax
      ...
      void emit_f64_max() {
         auto icount = softfloat_instr(49, 47);
         if(use_softfloat) {
            emit_f64_binop_softfloat(CHOOSE_FN(_inery_f64_max));
            return;
         }
         // mov (%rsp), %rax
         emit_bytes(0x48, 0x8b, 0x04, 0x24);
      ...
      void emit_i32_trunc_s_f32() {
         ...
         if constexpr (use_softfloat) {
            return emit_softfloat_unop(CHOOSE_FN(softfloat_trap<&_inery_f32_trunc_i32s>()));
         }
         // cvttss2si 8(%rsp), %eax
      ...
      void emit_i32_trunc_u_f32() {
         ...
         if constexpr (use_softfloat) {
            return emit_softfloat_unop(CHOOSE_FN(softfloat_trap<&_inery_f32_trunc_i32u>()));
         }
         // cvttss2si 8(%rsp), %rax
      ...
      void emit_i32_trunc_s_f64() {
         ...
         if constexpr (use_softfloat) {
            return emit_softfloat_unop(CHOOSE_FN(softfloat_trap<&_inery_f64_trunc_i32s>()));
         }
         // cvttsd2si 8(%rsp), %eax
      ...
      void emit_i32_trunc_u_f64() {
         ...
         if constexpr (use_softfloat) {
            return emit_softfloat_unop(CHOOSE_FN(softfloat_trap<&_inery_f64_trunc_i32u>()));
         }
         // cvttsd2si 8(%rsp), %rax
      ...
      void emit_i64_trunc_s_f32() {
         ...
         if constexpr (use_softfloat) {
            return emit_softfloat_unop(CHOOSE_FN(softfloat_trap<&_inery_f32_trunc_i64s>()));
         }
         // cvttss2si (%rsp), %rax
         emit_f2i(0xf3, 0x48, 0x0f, 0x2c, 0x44, 0x24, 0x08);
         // mov %rax, (%rsp)
      ...
      void emit_i64_trunc_u_f32() {
         ...
         if constexpr (use_softfloat) {
            return emit_softfloat_unop(CHOOSE_FN(softfloat_trap<&_inery_f32_trunc_i64u>()));
         }
         // mov $0x5f000000, %eax
         emit_bytes(0xb8);
      ...
      void emit_i64_trunc_s_f64() {
         ...
         if constexpr (use_softfloat) {
            return emit_softfloat_unop(CHOOSE_FN(softfloat_trap<&_inery_f64_trunc_i64s>()));
         }
         // cvttsd2si (%rsp), %rax
         emit_f2i(0xf2, 0x48, 0x0f, 0x2c, 0x44, 0x24, 0x08);
         // mov %rax, (%rsp)
      ...
      void emit_i64_trunc_u_f64() {
         ...
         if constexpr (use_softfloat) {
            return emit_softfloat_unop(CHOOSE_FN(softfloat_trap<&_inery_f64_trunc_i64u>()));
         }
      ...
      void emit_f32_convert_s_i32() {
         auto icount = softfloat_instr(10, 36);
         if constexpr (use_softfloat) {
            return emit_softfloat_unop(CHOOSE_FN(_inery_i32_to_f32));
         }
         // cvtsi2ssl (%rsp), %xmm0
      ...
      void emit_f32_convert_u_i32() {
         ...
         if constexpr (use_softfloat) {
            return emit_softfloat_unop(CHOOSE_FN(_inery_ui32_to_f32));
         }
      ...
      void emit_f32_convert_s_i64() {
         ...
         if constexpr (use_softfloat) {
            return emit_softfloat_unop(CHOOSE_FN(_inery_i64_to_f32));
         }
         // cvtsi2sslq (%rsp), %xmm0
         emit_bytes(0xf3, 0x48, 0x0f, 0x2a, 0x04, 0x24);
         // movss %xmm0, (%rsp)
      ...
      void emit_f32_convert_u_i64() {
         ...
         if constexpr (use_softfloat) {
            return emit_softfloat_unop(CHOOSE_FN(_inery_ui64_to_f32));
         }
        // movq (%rsp), %rax
        emit_bytes(0x48, 0x8b, 0x04, 0x24);
        // testq %rax, %rax
      ...
      void emit_f32_demote_f64() {
         auto icount = softfloat_instr(10, 38);
         if constexpr (use_softfloat) {
            return emit_softfloat_unop(CHOOSE_FN(_inery_f64_demote));
         }
         // cvtsd2ss (%rsp), %xmm0
      ...
      void emit_f64_convert_s_i32() {
         ...
         if constexpr (use_softfloat) {
            return emit_softfloat_unop(CHOOSE_FN(_inery_i32_to_f64));
         }
         // cvtsi2sdl (%rsp), %xmm0
      ...
      void emit_f64_convert_u_i32() {
         ...
         if constexpr (use_softfloat) {
            return emit_softfloat_unop(CHOOSE_FN(_inery_ui32_to_f64));
         }
         //  cvtsi2sdq (%rsp), %xmm0
      ...
      void emit_f64_convert_s_i64() {
         auto icount = softfloat_instr(11, 38);
         if constexpr (use_softfloat) {
            return emit_softfloat_unop(CHOOSE_FN(_inery_i64_to_f64));
         }
         //  cvtsi2sdq (%rsp), %xmm0
         emit_bytes(0xf2, 0x48, 0x0f, 0x2a, 0x04, 0x24);
         // movsd %xmm0, (%rsp)
      ...
      void emit_f64_convert_u_i64() {
         ...
         if constexpr (use_softfloat) {
            return emit_softfloat_unop(CHOOSE_FN(_inery_ui64_to_f64));
         }
        // movq (%rsp), %rax
        emit_bytes(0x48, 0x8b, 0x04, 0x24);
        // testq %rax, %rax
      ...
      void emit_f64_promote_f32() {
         auto icount = softfloat_instr(10, 37);
         if constexpr (use_softfloat) {
            return emit_softfloat_unop(CHOOSE_FN(_inery_f32_promote));
         }
         // cvtss2sd (%rsp), %xmm0
...
#undef CHOOSE_FN
    ...
    private:
...
#ifdef INE_VM_VALIDATE_JIT_SIZE
     ...
     void* emit_branch_target32() {
      ...
      static void unimplemented() { INE_VM_ASSERT(false, wasm_parse_exception, "Sorry, not implemented."); }
